...
//        HashOperate(); 
    ...
    { 
        ...
        System.out.println("修改zset集合中element001元素的分数:"+shardedJedis.zincrby("zset", 5.0, "element001"));
        System.out.println("zset集合中元素分数排名："+shardedJedis.zrevrange("zset", 0, -1));
    }
	...
	public static void main(String[] arg0){
		...
		list.add(new JedisShardInfo("127.0.0.1", 6379, "admin"));
		
		JedisPool jp = new JedisPool(jpc, "127.0.0.1", 6379);
		Jedis j = jp.getResource();
		
		ShardedJedisPool shardJedisPool = new ShardedJedisPool(jpc, list);
		ShardedJedis shardJedis = shardJedisPool.getResource();
		j.flushDB();
		
		shardJedis.lpush("numList", "1");
		shardJedis.lpush("numList", "7");
		shardJedis.lpush("numList", "5");
		shardJedis.lpush("numList", "7");
		shardJedis.lpush("numList", "8");
		shardJedis.lpush("numList", "10");
		shardJedis.lpush("numList", "12");
		System.out.println(shardJedis.lrange("numList", 0, -1));
		System.out.println(shardJedis.lrem("numList", 1, "7"));
		System.out.println(shardJedis.ltrim("numList", 1, 4));
		System.out.println(shardJedis.lpop("numList"));
		System.out.println(shardJedis.lset("numList", 1, "9"));
		System.out.println(shardJedis.llen("numList"));
		System.out.println(shardJedis.lindex("numList", 2));
		System.out.println(shardJedis.lrange("numList", 0, -1));
	}
}
