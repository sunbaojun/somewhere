 ...
 * @author luolin
 *
 * @version $id:DB2Generator.java,v 0.1 2015年12月15日 上午10:33:29 luolin Exp $
 */
public class DB2Generator {

    private static final String DB_URL      = "jdbc:db2://192.168.110.68:50000/HPE0313";
    private static final String DB_USERL    = "db2inst1";
    private static final String DB_PWD      = "op400230";
    ...
    private static List<TableInfo> getTableInfo(Map<String, String> tableNames) throws SQLException {
        ...
        for (String key : tableNames.keySet()) {
            TableInfo ti = new TableInfo(key, tableNames.get(key), FieldUtils.getDB2FieldInfo(key, DB_URL, DB_USERL,
                DB_PWD));
            tables.add(ti);
        }
        return tables;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            map.put("BSS_ASSET".toLowerCase(), "资产设备");
