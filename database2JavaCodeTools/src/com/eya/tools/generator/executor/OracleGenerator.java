 ...
 * @author luolin
 *
 * @version $id:OracleGenerator.java,v 0.1 2015年12月15日 上午10:35:50 luolin Exp $
 */
public class OracleGenerator {

    private static final String DB_URL      = "jdbc:oracle:thin:root/root@127.0.0.1:1521:orcl";
    ...
    private static List<TableInfo> getTableInfo(Map<String, String> tableNames) throws SQLException {
        ...
        for (String key : tableNames.keySet()) {
            TableInfo ti = new TableInfo(key, tableNames.get(key), FieldUtils.getOracleFieldInfo(key, DB_URL, DB_USERL,
                DB_PWD));
            tables.add(ti);
        }
        return tables;
